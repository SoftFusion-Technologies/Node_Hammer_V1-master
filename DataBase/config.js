...
export const DB_PASSWORD = process.env.DB_PASSWORD || 'matyotto29';
export const DB_NAME = process.env.DB_NAME || 'DB_HammerDESA_c1841398'; // Asegúrate de que la base de datos sea la correcta
