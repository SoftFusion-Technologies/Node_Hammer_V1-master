...
export class VentasComisionesVigentesModel extends Model {}

VentasComisionesVigentesModel.init(
  {
    id: {
  ...
  {
    sequelize: db,
    modelName: 'ventas_comisiones_vigentes',
    tableName: 'ventas_comisiones_vigentes',
    timestamps: true,
    ...
    indexes: [
      ...
      {
        name: 'uq_periodo_codigo',
        unique: true,
        fields: ['periodo_inicio', 'codigo']
      },
      { name: 'idx_activo_periodo', fields: ['activo', 'periodo_inicio'] },
      { name: 'idx_codigo', fields: ['codigo'] }
    ],
...
export default { VentasComisionesVigentesModel };
